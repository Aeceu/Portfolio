...
const Contact = () => {
  ...
  return (
    <div id="contact-page" className="relative min-h-[700px] flex flex-col items-center p-4 gap-8">
      ...
      <div className="w-full h-full flex items-center justify-center">
        <form onSubmit={handleSubmit} className="min-w-[300px] w-[500px] h-full flex flex-col items-start gap-6 p-2">
          <h1
